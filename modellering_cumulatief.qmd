...
Het cumulatief logistische model is volgens mij het meest correcte model om de data te modelleren. Er worden geen aannames gedaan over de verdeling van de data. Er wordt berekend wat de cumulatieve kans is op een score. Dit betekent dat het model de kans berekent dat een ecosysteemdienst een bepaalde score of lager heeft, in plaats van de kans op een specifieke score te berekenen.

Net als bij het model met de gewogen gemiddeldes wordt met een random intercept op case gewerkt om zo rekening te houden met dat cases over de hele lijn hoger of lager kunnen scoren dan andere cases.
